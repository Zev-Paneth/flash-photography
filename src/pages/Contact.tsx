...
const Contact: React.FC = () => {
    ...
    return (
        <div className="pt-20">
            <MetaTags
                title="Contact Us | Flash Photography"
                description="Get in touch with our photography studio for inquiries or to book a session. We offer newborn, children, and family photography services."
                keywords="contact photographer, book photoshoot, photography inquiry, family photographer contact, newborn photography booking"
            />
                            ...
                            <div>
                                ...
                                >
                                    ...
                                    <option value="children">
                                        <FormattedMessage id="services.children.title" defaultMessage="Children Photography" />
                                    </option>
                                    <option value="family">
                                        <FormattedMessage id="services.family.title" defaultMessage="Family Photography" />
                                    </option>
                                </select>
                            </div>
                            <div>
